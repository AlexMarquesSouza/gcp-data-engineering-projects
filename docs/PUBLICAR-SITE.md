...
1. Abra [Settings → Pages](https://github.com/AlexMarquesSouza/gcp-data-engineering-projects/settings/pages).
...
```text
https://alexmarquessouza.github.io/gcp-data-engineering-projects/
```
